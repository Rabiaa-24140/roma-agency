...
export default function RomaApp() {
  ...
  /* ── Color tokens ── */
  const bg          = dark ? "#0D0505" : "#F4F1EE";
  const surface     = dark ? "#1A0808" : "#FFFFFF";
  const surfaceAlt  = dark ? "#120505" : "#F0EBE3";
  const text        = dark ? "#F4F1EE" : "#1A0808";
  const textMuted   = dark ? "#8A6868" : "#6B5555";
  const burg        = "#5A0606";
